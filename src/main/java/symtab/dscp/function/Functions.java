...
public class Functions {
...

    {
        ...
        FunctionDescriptor input = new FunctionDescriptor();
        VariableDescriptor inputParam = new VariableDescriptor();
        parameterList = new ArrayList<>();
        inputParam.setName("a");
        inputParam.setConst(false);
        inputParam.setType(Type.INT);
        input.setName("input");
        input.setCompleteDCL(true);
        input.setReturnType(Type.VOID);
        input.setParameterTypes(Type.INT);
        parameterList.add(inputParam);
        input.setParameters(parameterList);
